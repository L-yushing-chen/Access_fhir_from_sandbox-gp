(function(window){
  ...
  var mrn ='';
  var fin='';
  var nm = p.fname + "+" + p.lname;
   
  var es_dataUrl = "edipi=" + edipi + "icn=" + icn + "&" + "name=" + nm + "&" + "dob=" + p.birthdate + "&" +"sex=" + p.gender + "&" + "fin=" + fin + "&" + "mrn=" + mrn  ;
  var es_url_str = "https://usvadceapp.lcahncrls.net/?data="+ es_dataUrl;
  
  $('#es_url').html(es_url_str);
